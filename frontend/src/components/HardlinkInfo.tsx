...
export function HardlinkInfo({ linkedPaths }: { linkedPaths: string[] }) {
  ...
  return (
    <Tooltip>
      <TooltipTrigger
        render={
          <button type="button" className="text-muted-foreground hover:text-foreground" aria-label="Hardlink" />
        }
      >
      ...
      <TooltipContent side="right" className="max-w-sm">
        <div className="grid gap-0.5">
          <span className="font-medium">Hardlink ({linkedPaths.length})</span>
