...
# tipicamente 99:100) — evita che le cartelle create dal tool finiscano
# possedute da root sull'array.
#
...
# default) così il container parte comunque invece di crashare — i
